\begin{figure}[htp]
	...
	\begin{tikzpicture}[scale=0.75]
		...
		\draw (0.5,6) -- ++(0,1);
		\node at (0.25, 6.5) {\small R};
		\draw (1,6) -- ++(0,1);
		\node at (0.75, 6.5) {\small S};
		\draw (1.5,6) -- ++(0,1);
		\node at (1.25, 6.5) {\small O};
		...
		\draw (4,2) -- (4,1);
		\node at (2,1.5) {\small 2 (TLLAO)};
		\draw (8,2) -- (8,1);
		\node at (6, 1.5) {\small 1 (Length)};
		\node at (12, 1.5) {\small Target Link-Layer Address ...};
		\draw (0,1) -- ++(16,0);
		\node at (8, 0.5) {\small ...};

	\end{tikzpicture}
	\end{center}
	\caption{Neighbor Advertisement Message Example}
	\label{fig:ipv6_na}
\end{figure}